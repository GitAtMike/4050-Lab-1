# CS4050: Advanced Route Planning - Multi-Constraint Pathfinding
...
Write a "formal-ish[^1]" proof that includes:

[^1]: I am interested in your ability to explain your assumptions, and describe why your algorithm is correct. Formal proofs are ok, but if you are not comfortable trying to write them, just use ordinary words to describe why you think your algorithm is correct. 
